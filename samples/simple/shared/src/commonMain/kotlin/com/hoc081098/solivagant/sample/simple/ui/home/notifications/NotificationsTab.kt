  ...
  Surface(
    ...
    Box(
      ...
      Column(
        ...
        Text(
          text = "Notifications: viewModel=${viewModel.debugDescription}, route=${viewModel.route}",
        ...
        ElevatedButton(onClick = remember { viewModel::navigateToNestedNotifications }) {
          Text(text = "To nested notifications")
        }
      }
    }
  }
