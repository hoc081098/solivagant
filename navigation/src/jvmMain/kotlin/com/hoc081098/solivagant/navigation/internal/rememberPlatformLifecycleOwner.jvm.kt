...
private object DefaultDesktopLifecycleOwner : LifecycleOwner {
  override val lifecycle: Lifecycle = LifecycleRegistry(initialState = Lifecycle.State.RESUMED)
}

@Composable
internal actual fun rememberPlatformLifecycleOwner(): LifecycleOwner = DefaultDesktopLifecycleOwner
